...
def main():
    print("Bienvenue sur mon application, c'est un petit programme dans le cadre du cours de Sécurité Informatique")
    print("Travail réalisé par Bourgeois KIMBONDO MANU")
